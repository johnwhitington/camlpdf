...
pdfcryptprimitives pdfcrypt pdfflate pdfcodec pdfwrite pdfgenlex pdfread pdfjpeg pdfops pdfdest \
...
SOURCES = flatestubs.c rijndael-alg-fst.c stubs-aes.c $(foreach x,$(PDFMODS),$(x).ml $(x).mli)
