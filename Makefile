...
PDFMODS = pdfe pdfutil pdfio pdftransform pdfunits pdfpaper \
  ...
  pdfannot pdffun pdfspace pdfimage pdfafm pdfafmdata pdfglyphlist pdfcmapdata \
  pdfcmap pdftext pdfstandard14 pdfdate pdfocg pdfmerge
...
clean ::
	...
	rm -rf examples/out.pdf examples/out2.pdf examples/foo examples/foo2
